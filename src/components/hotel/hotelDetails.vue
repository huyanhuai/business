<template lang="pug">
  <div class="packageAdd" ref="packageAdd"> 
    ...
    <div style="width:100%;height: 650px;overflow: auto;" ref="kuang"> 
      ...
      <div style="margin-top:10px;">
        ...
        //-   <h3>酒店封面图片：</h3>
        //-   <div style="width:120px;height:120px;position: relative;border: 1px solid #DCDCDC;">
        //-     <Upload :before-upload="hotelCoverUpload" :show-upload-list="false" action="//jsonplaceholder.typicode.com/posts/"> 
        //-       <img :src="hotelCoverImg" style="width:120px;height:120px;">
        ...
        <div >
          ...
          <div style="width:120px;height:150px;position: relative;border: 1px solid #DCDCDC;">
      ...
      <div style="margin-top:20px;background:#fff;clear:both;"> 
          <h3>外景图片</h3>
...
export default {
  ...
  data() {
    return {
      ...
      isReally: "",
      hotelCover: "",
      hotelCoverImg: require("../../assets/Home/a11.png"),
    ...
    series: function(val) {
      ...
      this.axios
        ...
        .then(res => {
          ...
          this.isReally = isReally.toString();
          this.hotelInformation.starLevel = starLevel;
          this.hotelInformation.coverImg = coverImg;
          if(coverImg != "" && coverImg != null) {
            this.posterImg = this.ImgUrl + coverImg + ".jpg";
          }else {
      ...
      this.axios
        ...
        .then(res => {
          if (res.errorCode == 200) {
            ...
            this.hotelCover = res.data;
            reader.readAsDataURL(file);
            reader.onload = function(e) {
              _this.hotelCoverImg = this.result;
            };
          }else{
            this.error("图片上传错误");
            this.hotelCoverImg = require("./../../assets/Home/a11.png");
          }
        })
        .catch(err => {});
    },
      ...
      this.axios
        ...
        .then(res => {
          if (res.errorCode == 200) {
            ...
            this.hotelInformation.coverImg = res.data;
          }else{
            this.error("图片上传错误")
            this.spinShowImg = false;
            this.posterImg = require("../../assets/Home/a11.png");
